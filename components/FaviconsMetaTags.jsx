export function FaviconsMetaTags() {
  return (
    <>
      ...
      <meta content={process.env.NEXT_PUBLIC_WEBSITE_NAME} name="application-name" />
      ...
      <meta content={process.env.NEXT_PUBLIC_WEBSITE_NAME} name="apple-mobile-web-app-title" />
      <link
