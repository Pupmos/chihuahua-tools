  ...
  return (
    <section className="px-8 pt-4 pb-16 mx-auto space-y-8 max-w-4xl">
      <div className="flex justify-center items-center py-8 max-w-xl">
        <img alt="logo" className="w-full text-plumbus" src={Brand.src} />
      </div>
      <h1 className="font-heading text-4xl font-bold">Welcome!</h1>
      <p className="text-xl">
        {process.env.NEXT_PUBLIC_WEBSITE_NAME} is a Swiss Army knife that helps you build on{' '}
        {process.env.NEXT_PUBLIC_NETWORK_NAME} by providing smart contract front ends. We call these front-end apps{' '}
